...
#${CLOUDSDK_COMPUTE_ZONE} come from travis setting
...
#${CLUSTER_NAME_STG} come from travis setting
...
kubectl delete deployment order --namespace=dev --ignore-not-found=true
kubectl delete service order --namespace=dev --ignore-not-found=true
